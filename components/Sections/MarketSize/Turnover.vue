...
const profitabilityData = {
  labels: props.profitability[0].points.map((item) => item.label),
  datasets: [
    {
      type: "bar",
      label: props.profitability[0].dataset,
      backgroundColor: "#273D6C",
      borderColor: "#273D6C",
      barThickness: 60,
      borderWidth: 1,
      data: props.profitability[0].points.map((item) => item.point_value),
      yAxisID: "y",
      order: 2,
    },
    {
      type: "line",
      label: props.profitability[1].dataset,
      borderWidth: 1,
      pointRadius: 7,
      pointStyle: "rect",
      borderColor: "#6B4747",
      ...
      fill: false,
      data: props.profitability[1].points.map((item) => item.point_value),
      yAxisID: "y1",
      order: 2,
      datalabels: {
        color: "#6B4747",
